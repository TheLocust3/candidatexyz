...
# default panels (pasted)
Panel.create(name: "Footer", description: "", elements: {"0"=>{"index"=>"0", "uuid"=>"row-5d6a6987-adb4-4d37-a8d4-551d5edc8f81", "type"=>"row", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"cell-da970393-39f2-449a-a73d-878dc57b11cf", "type"=>"cell", "width"=>"7.142857142857143"}, "1"=>{"index"=>"1", "uuid"=>"cell-3a57a8cb-7d6a-4f65-ab78-72faf82c8fed", "type"=>"cell", "width"=>"7.142857142857143"}, "2"=>{"index"=>"2", "uuid"=>"cell-4335a022-31cd-49d0-a638-61e9c8e66510", "type"=>"cell", "width"=>"7.142857142857143"}, "3"=>{"index"=>"3", "uuid"=>"cell-5d7f8e46-0452-4dcd-843f-f51bb5a71b3c", "type"=>"cell", "width"=>"7.142857142857143"}, "4"=>{"index"=>"4", "uuid"=>"cell-5b621232-b262-4c80-833d-968f6ec75c13", "type"=>"cell", "width"=>"7.142857142857143"}, "5"=>{"index"=>"5", "uuid"=>"cell-791ec571-6191-4568-a5de-9230c61f810b", "type"=>"cell", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"iconButton-4ca6f969-8bc1-4ca8-9bab-408148e09efe", "type"=>"iconButton", "icon"=>"fa-facebook-f", "action"=>"link", "actionData"=>"http://www.facebook.com/", "theme"=>{"color"=>"#ffffff", "fontSize"=>"2em", "colorHover"=>"#cccccc"}}}, "width"=>"7.142857142857143"}, "6"=>{"index"=>"6", "uuid"=>"cell-535dd89c-45fc-4750-82f6-1596484b2165", "type"=>"cell", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"iconButton-1176210e-82e6-4d0d-80cb-527842159b45", "type"=>"iconButton", "icon"=>"fa-twitter", "action"=>"link", "actionData"=>"http://www.twitter.com/", "theme"=>{"color"=>"#ffffff", "fontSize"=>"2em", "colorHover"=>"#cccccc"}}}, "width"=>"7.142857142857143"}, "7"=>{"index"=>"7", "uuid"=>"cell-c853af4d-2a5d-472f-b1d7-3b880e55537b", "type"=>"cell", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"iconButton-81cbfb33-ee07-47c9-b007-104cd4cb86f5", "type"=>"iconButton", "icon"=>"fa-instagram", "action"=>"link", "actionData"=>"http://www.instagram.com/", "theme"=>{"color"=>"#ffffff", "colorHover"=>"#cccccc", "fontSize"=>"2em"}}}, "width"=>"7.142857142857143"}, "8"=>{"index"=>"8", "uuid"=>"cell-b9b5ed0c-1f2c-450a-9974-602e5ff112bb", "type"=>"cell", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"iconButton-162d4bd5-3fe3-48da-b8d1-c3618885b0ea", "type"=>"iconButton", "icon"=>"fa-youtube", "action"=>"link", "actionData"=>"http://www.youtube.com/", "theme"=>{"color"=>"#ffffff", "colorHover"=>"#cccccc", "fontSize"=>"2em"}}}, "width"=>"7.142857142857143"}, "9"=>{"index"=>"9", "uuid"=>"cell-dcbbbd92-5c51-4185-9102-1707486894f2", "type"=>"cell", "width"=>"7.142857142857143"}, "10"=>{"index"=>"10", "uuid"=>"cell-4cc61153-03b6-4d15-b115-8fd6511199ed", "type"=>"cell", "width"=>"7.142857142857143"}, "11"=>{"index"=>"11", "uuid"=>"cell-cac9b2ae-790a-4a88-b0be-fc21d3f450b0", "type"=>"cell", "width"=>"7.142857142857143"}, "12"=>{"index"=>"12", "uuid"=>"cell-7928f3fe-bbcf-4367-b7ba-93644beeaecc", "type"=>"cell", "width"=>"7.142857142857143"}, "13"=>{"index"=>"13", "uuid"=>"cell-8f619233-5d60-42ce-bd2a-e650732ff006", "type"=>"cell", "width"=>"7.142857142857143"}}, "height"=>"10"}, "1"=>{"index"=>"1", "uuid"=>"row-75a5e4d0-2505-4a73-83c8-21fc5726d671", "type"=>"row", "height"=>"10", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"cell-bf5ba5e2-1bee-4958-a7dd-0336cdcb8e04", "type"=>"cell", "width"=>"16.666666666666668"}, "1"=>{"index"=>"1", "uuid"=>"cell-6c78ca80-1787-47a6-bd8c-eeb9a4ce141d", "type"=>"cell", "width"=>"16.666666666666668"}, "2"=>{"index"=>"2", "uuid"=>"cell-cd7b921e-3da2-4013-bc7f-334f447f86d7", "type"=>"cell", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"link-301ccde9-4ac0-4cf3-802b-e4678138ad2b", "type"=>"link", "text"=>"Contact", "url"=>"/contact", "theme"=>{"color"=>"#ffffff", "custom"=>{"textDecoration"=>"none"}, "colorHover"=>"#cccccc"}}}, "width"=>"16.666666666666668"}, "3"=>{"index"=>"3", "uuid"=>"cell-80bc2d73-e0fe-48ee-97f5-3bd40fc2c2b2", "type"=>"cell", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"link-b208adfe-eccd-471a-8297-6af1c08bbf9e", "type"=>"link", "text"=>"Privacy", "url"=>"/privacy", "theme"=>{"color"=>"#ffffff", "custom"=>{"textDecoration"=>"none"}, "colorHover"=>"#cccccc"}}}, "width"=>"16.666666666666668"}, "4"=>{"index"=>"4", "uuid"=>"cell-ea74e2be-45e2-4cf6-a680-36ade6ce9cd8", "type"=>"cell", "width"=>"16.666666666666668"}, "5"=>{"index"=>"5", "uuid"=>"cell-047826fa-e740-4ca2-8f88-de043e910fce", "type"=>"cell", "width"=>"16.666666666666668"}}}, "2"=>{"index"=>"2", "uuid"=>"row-d90b9daa-1afa-496d-a425-4cf0ffdd7ea1", "type"=>"row", "height"=>"7.5", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"cell-58717838-5139-46df-883f-b932fc5da523", "type"=>"cell", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"link-af953316-c5da-4f0d-b931-acfafc149b1c", "type"=>"link", "text"=>"Staff Login", "url"=>"/sign-in", "theme"=>{"color"=>"#ffffff", "colorHover"=>"#cccccc", "custom"=>{"textDecoration"=>"none"}, "fontSize"=>"18px"}}}, "width"=>"100"}}}, "3"=>{"index"=>"3", "uuid"=>"row-1899644b-4af4-4125-b4a8-975a2f6c4605", "type"=>"row", "height"=>"12.5", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"cell-a8d3ed39-f122-4d0e-aa87-9b82bb31f163", "type"=>"cell", "elements"=>{"0"=>{"index"=>"0", "uuid"=>"text-6b64b528-6ffc-4a5a-8748-dba7ed1807df", "type"=>"text", "text"=>"<p style=\"text-align:center;\"><span style=\"font-size: 12px;\">APPROVED BYCANDIDATEXYZ.</span></p>\n<p style=\"text-align:center;\"><span style=\"font-size: 12px;\">PAID FOR BY CANDIDATEXYZ FOR OFFICE.</span></p>\n<p style=\"text-align:center;\"><span style=\"font-size: 12px;\">ADDRESS</span></p>\n", "theme"=>{"custom"=>{"border"=>"#ccc solid 1px", "width"=>"250px", "margin"=>"auto"}}}}, "width"=>"100"}}}}, settings: {"height"=>"40", "theme"=>{"backgroundColor"=>"#00427c", "custom"=>{"color"=>"white"}}})
