...
class TextFieldSidebar extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <TextFieldStyler theme={element.theme} updateTheme={(theme) => this.updateTheme(theme)} />
...
TextFieldSidebar.propTypes = {
    elements: PropTypes.array,
    element: PropTypes.object,
    updateInnerElements: PropTypes.func
};

export default TextFieldSidebar;
