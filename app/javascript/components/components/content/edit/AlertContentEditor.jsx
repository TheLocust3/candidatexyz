...
class AlertContentEditor extends React.Component {
    ...
    render() {
        return (
            <FormWrapper handleSubmit={(event) => this.handleSubmit(event)}>
                <TextField label='Text' name='text' onChange={(event) => this.handleContentChange(event)} defaultValue={this.props.content.content.text} size={40} />
...
AlertContentEditor.propTypes = {
    content: PropTypes.object.isRequired
};

export default connect()(AlertContentEditor);
